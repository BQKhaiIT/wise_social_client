    ...
    <div class="col-lg-6 col-md-8 no-pd">
        <div class="main-ws-sec">
            <div class="post-topbar">
                <textarea name="post_area" id="post_area" class="form-control">何を考えていますか?</textarea>
                <div class="chose-image">
                    <ul>
                        <li>
                            <label for="btn_chose_file" class="btn btn-danger"
                                title="Chose file .png or .jpeg">画像を選択</label>
                            <input type="file" class="btn btn-danger" name="chose-file" id="btn_chose_file">
                        </li>
                    </ul>
                </div>
                <div class="post-st">
                    <ul>
                        <li><a class="active" href="#" title="Submit post data">送信</a></li>
                    </ul>
                </div>
                <!--post-st end-->
            </div>
            ...
            <div class="posts-section">
                <div class="post-bar">
                    ...
                    <div class="epi-sec">
                        <ul class="descp">
                            <!-- Jobs -->
                            <li><img src="../assets/images/icon8.png" alt=""><span>元首相</span></li>
                            <!-- Nationality -->
                            <li><img src="../assets/images/icon9.png" alt=""><span>VietNam</span></li>
                        </ul>
                        <ul class="bk-links">
                            <!-- Add to bookmark -->
                            <li><a href="#" title=""><i class="fa fa-bookmark"></i></a></li>
                            <!-- Go to message page -->
                            <li><a href="messages.html" title=""><i class="fa fa-envelope"></i></a></li>
                        </ul>
                    </div>
                    <!-- Post description -->
                    <div class="job_descp">
                        ...
                        <p>中際提けトイつ売主ケキ膀認ねず務法債ぞろ惜禁け割門9要ワキ家際ほもば木久まき容純菜ぎぽぞ載動宅略石れざきこ。。。 <a href="#" title="">もっと見る</a></p>
                    </div>
                    <hr>
                    ...
                    <div class="job-status-bar">
                        <ul class="like-com">
                            ...
                            <li>
                                <a class="color-b2b2b2 cusror-poiter hover-color"><i class="fa fa-comment-alt"></i> コメント
                                    (15)</a>
                            </li>
                        </ul>
                ...
                <div class="post-bar">
                    ...
                    <div class="epi-sec">
                        <ul class="descp">
                            <li><img src="../assets/images/icon8.png" alt=""><span>元大統領</span></li>
                            <li><img src="../assets/images/icon9.png" alt=""><span>VietNam</span></li>
                        </ul>
                        <ul class="bk-links">
                            <li><a href="#" title=""><i class="fa fa-bookmark"></i></a></li>
                    ...
                    <div class="job_descp">
                        ...
                        <p>中際提けトイつ売主ケキ膀認ねず務法債ぞろ惜禁け割門9要ワキ家際ほもば木久まき容純菜ぎぽぞ載動宅略石れざきこ。合そいやぶ間準ヌイヘミ罪高そ県1人スヲナ月7神いこ港彬ホヨアタ最非3争ミイホヘ生要きゅ熱覧ょ式司フホメ究真メスチコ革面じ訓準晶ぼフを。足リみぴ術並ちときか強官リ氷任ノヤ帳済ユコニ専氏ヌレトム登様どにだ主産ノハミ出講ヲレヤ点本レ死海さッぴ属被骨け歳乗歌規なそご。。。
                ...
                <div class="posty">
                    <div class="post-bar no-margin">
                        ...
                        <div class="epi-sec">
                            <ul class="descp">
                                <li><img src="../assets/images/icon8.png" alt=""><span>宇宙予言</span>
                                </li>
                                <li><img src="../assets/images/icon9.png" alt=""><span>India</span>
                                </li>
                            </ul>
                            <ul class="bk-links">
                                <li><a href="#" title=""><i class="fa fa-bookmark"></i></a>
                                </li>
                                <li><a href="#" title=""><i class="fa fa-envelope"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="job_descp">
                            ...
                            <p>主ケキ膀認ねず務法債中際提けトイつ売ぞろ惜禁け割門9要ワキ家際ほもば木久まき容純菜ぎぽぞ載動宅略石れざきこ。。。 <a href="#" title="">もっと見る</a>
                            </p>
                            <ul class="skill-tags">
                                <li><a href="#" title="">アメリカ共和党顧問</a></li>
                                <li><a href="#" title="">ベトナム共産党スパイ</a></li>
                            </ul>
                        </div>
                        <div class="job-status-bar">
                            <ul class="like-com">
