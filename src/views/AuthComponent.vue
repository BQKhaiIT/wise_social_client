                        ...
                        <div class="col-lg-6">
                            <div class="login-sec">
                                <ul class="sign-control">
                                    <li data-tab="tab-1" v-on:click="chooseType('login')"
                                        :class="{ current: choseType == 'login' }"><a href="#" title="">サインイン</a></li>
                                    <li data-tab="tab-2" v-on:click="chooseType('register')"
                                        :class="{ current: choseType == 'register' }"><a href="#" title="">サインアップ</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        ...
                                                        <span class="text-danger msgError">{{ registerErrEmailMsg
                                                            }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" name="name" v-model="registerFullName"
                                                            placeholder="氏名">
                                                        <i class="fa fa-user"></i>
                                                ...
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" name="country" v-model="registerCountry"
                                                            placeholder="国">
                                                ...
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="password" v-model="registerRePassword"
                                                ...
                                                <div class="col-lg-12 no-pdd row">
                                                    <button :class="{ 'cursor-not-allow': this.registerTOS === false }"
                                                        ...
                                                        v-on:click="registerValidation()">開始する</button>
                                                    <img class="btn-register"
                                                        :class="{ 'display-none': this.registerProcess === false }"
                                                        width="40px" height="40px" src="/src/assets/loading_icon.gif"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    watch: {
        ...
        token () {
            console.log("When the value of the token variable changes, this method will be executed.");
        }
    },
    computed: {
        appendMsg() {
